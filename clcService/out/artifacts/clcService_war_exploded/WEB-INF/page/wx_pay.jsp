...
<body>
<img id="back_1" src="${pageContext.request.contextPath}/mer_picture/back_1.png" style="display:none;position: absolute;left: 0%;top: 0%;width: 100%;height: 100%">
<img id="back_2" src="${pageContext.request.contextPath}/mer_picture/wx_pyq_bg.png" style="position: absolute;left: 0%;top: 0%;width: 100%;height: 100%;display: none">
<img id="back_3" src="${pageContext.request.contextPath}/mer_picture/wait.gif" style="position: absolute;left: 40%;top: 50%;width: 20%;height: auto;display: none">
</body>
</html>